...
| Topic | Description |
|---|---|
| [Controllers and Routing](Controllers-and-Routing.md) | Defining controllers, topic templates, parameter binding, custom parsers |
...
| [Connection Validation](Connection-Validation.md) | Pre-auth hooks, IP/ClientId filtering, session-item seeding |
